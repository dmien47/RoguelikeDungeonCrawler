...
public class LootPool {
    ...
    static {
        ...
        weaponPool.add(new Weapon("Long Sowrd", "Weapon", 15));
        weaponPool.add(new Weapon("Great Sowrd", "Weapon", 20));
        ...
        weaponPool.add(new Weapon("Theif's Dagger", "Weapon", 10));
        ...
        //armor
        //knight?
        armorPool.add(new Armor("Chainmail", "Armor", 12));
        armorPool.add(new Armor("Knight's Armor", "Armor", 20));
        armorPool.add(new Armor("Elite Knight's Armor", "Armor", 30));
        armorPool.add(new Armor("Dragonscale Armor", "Armor", 40));

        //rouge?
        armorPool.add(new Armor("Theif's Cloak", "Armor", 7));
    ...
    //will have to edit probabilites of getting higher tier stuff depending on dungeon difficulty or progression level later
    //maybe a 
