...
public class MindBender extends Enemy {
    public MindBender() {
        super("Mind Bender", 150, 35, 1000.0);
    }

    public MindBender(Enemy enemy) {
        super(enemy);
    }

//Swaps the players equipped armor and weapon at random from gear in their inventory
@Override
public void specialMove(Player player, Scanner scanner, Enemy enemy, Inventory inventory) { //chatgpt'd this one but it seems to be working fine
